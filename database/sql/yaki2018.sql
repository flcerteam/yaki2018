...
CREATE TABLE IF NOT EXISTS `branches` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_branches` (`name`)
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_categories` (`name`)
...
CREATE TABLE IF NOT EXISTS `order_statuses` (
  ...
  UNIQUE KEY `order_statuses_id_unique` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `order_status_histories` (
  ...
  KEY `order_status_histories_status_id_foreign` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'KV01', 'Bò tái chanh', NULL, 6, '1.0', '95000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(2, 'KV02', 'Cải chua trộn', NULL, 6, '1.0', '30000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(3, 'KV03', 'Gỏi rau càng cua thịt bò', NULL, 6, '1.0', '89000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(4, 'KV04', 'Gỏi bao tử heo', NULL, 6, '1.0', '79000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(5, 'KV05', 'Gỏi bò Mỹ', NULL, 6, '1.0', '95000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(6, 'KV06', 'Gỏi lưỡi heo', NULL, 6, '1.0', '79000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(7, 'KV07', 'Gỏi bò cải mầm', NULL, 6, '1.0', '85000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(8, 'KV08', 'Khoai môn tím chiên', NULL, 6, '1.0', '35000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(9, 'KV09', 'Khoai tây chiên', NULL, 6, '1.0', '39000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(10, 'KV10', 'Khô mực', NULL, 5, '1.0', '85000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(93, 'CXH74', 'Lương đồng um chuối', NULL, 12, '1.0', '120000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(94, 'CXH75', 'Lương đồng xào xả ớt', NULL, 12, '1.0', '95000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(95, 'CXH76', 'Luong dong QN', NULL, 7, '1.0', '399000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(113, 'CXH94', 'Nhộng xao (D7)', NULL, 6, '1.0', '65000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(218, 'N78', 'Pheo bo nuong ngu vi', NULL, 6, '1.0', '49000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(251, 'N111', 'Voucher Set nuong', NULL, 12, '1.0', '0', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(260, 'N120', 'Ốc Bưu nướng tiêu xanh', NULL, 6, '1.0', '65000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(264, 'CL04', 'Lẩu lương đồng', NULL, 1, '1.0', '150000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
(326, 'TU51', 'ruou SHOCHU HONKAKU', NULL, 3, '1.0', '240000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
(327, 'TU52', 'ruou mo UME HẠJIME 500 ml', NULL, 3, '1.0', '210000', 0, '2018-05-14 17:00:00', '2018-05-14 17:00:00'),
...
CREATE TABLE IF NOT EXISTS `reservation_tables` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `reservation_tables_member_id_foreign` (`member_id`),
  KEY `reservation_tables_branch_id_foreign` (`branch_id`),
  KEY `reservation_tables_status_id_foreign` (`status_id`),
  KEY `reservation_tables_rt_type_id_foreign` (`rt_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `rt_statuses`;
CREATE TABLE IF NOT EXISTS `rt_statuses` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  UNIQUE KEY `rt_statuses_id_unique` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `rt_status_histories`;
CREATE TABLE IF NOT EXISTS `rt_status_histories` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `rt_status_histories_rt_id_foreign` (`rt_id`),
  KEY `rt_status_histories_status_id_foreign` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `rt_types`;
CREATE TABLE IF NOT EXISTS `rt_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  UNIQUE KEY `rt_types_id_unique` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
